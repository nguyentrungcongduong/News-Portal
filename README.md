...
Hệ thống quản lý tin tức (CMS) chuyên nghiệp được xây dựng dựa trên kiến trúc hiện đại, tập trung vào trải nghiệm người dùng và quy trình nghiệp vụ tòa soạn thực tế.
...
- ⚙️ **[Quy trình Workflow (Post Workflow)](./docs/WORKFLOW.md)**: Chi tiết về vòng đời bài viết và phân quyền (Author, Editor, Admin).
...
Bạn có thể sử dụng các tài khoản sau để đăng nhập vào hệ thống Quản trị (Admin Panel):

| Vai trò (Role) | Email | Mật khẩu | Quyền hạn |
| :--- | :--- | :--- | :--- |
| **Quản trị viên (Admin)** | `admin@news.com` | `password` | Toàn quyền hệ thống, quản lý User, Duyệt bài |
| **Biên tập viên (Editor)** | `editor@news.com` | `password` | Quản lý danh mục, Chỉnh sửa và Duyệt bài viết |
| **Phóng viên (Author)** | `author@news.com` | `password` | Viết bài mới, Quản lý bài viết cá nhân |

> **Lưu ý:** Sau khi đăng nhập, vui lòng kiểm tra quy trình Workflow duyệt bài để hiểu rõ cơ chế vận hành của tòa soạn.
